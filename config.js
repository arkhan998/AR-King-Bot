...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://ARKing_Bot:ARKing_Bot@cluster1.0tlyzhm.mongodb.net/?retryWrites=true&w=majority" ;
global.port=5000  ;
global.audio = '' ; 
global.video = '' ;
...
global.github = 'https://github.com/arkhan998/AR-King-Bot' ;
global.location = 'Multan Pakistan' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Karachi'
global.gurl = 'https://youtube.com/@_900' ; // add your username
global.sudo =  process.env.SUDO || "923096566451" ;
global.devs = "923096566451"; //Dont change it From here
global.website = 'https://github.com/naveeddogar/AR-MD' ; //wa.me/+91000000000000
